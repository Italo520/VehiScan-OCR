...
import com.automacao.ocr.pipeline.PipelineDocumentoVeiculo;
...
public class MainExtracao {
    ...
    public static void main(String[] args) {
        try {
            ...
            ExtratorTexto extratorTexto = new ExtratorTextoImpl(tessdata, "por");
            ...
            PipelineDocumentoVeiculo pipeline = new PipelineDocumentoVeiculo(extratorTexto, extratorLLM, validador);
    ...
    private static void exibirResultado(DocumentoVeiculoDTO doc) {
        ...
        if (doc.getChassi().getStatus() != com.automacao.ocr.dto.CampoStatus.OK) {
